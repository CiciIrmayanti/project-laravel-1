    ...
    <div class="container">
        ...
        <div class="jumbotron jumbotron-fluid"
            ...
            <div class="container text-center">
                <img src="asset/application.png" alt="" width="20%" class="rounded-circle img-thumbnail">
        ...
        <div class="container">
            <div class="row mb-4 mt-4">
                <div class="col text-center">
                    <h2 style="font-family:Lucida Calligraphy"> PortoFolio</h2>
                </div>
            </div>
            <div id="carouselExampleCaptions" class="carousel slide" data-ride="carousel">
                ...
                <div class="carousel-inner">
                    <div class="carousel-item active">
                        <img src="asset/uji.png" class="d-block w-100" alt="...">
                        <div class="carousel-caption d-none d-md-block">
                            <h5>Tugas Uji Level</h5>
                        </div>
                    </div>
                    <div class="carousel-item">
                        <img src="asset/webb.png" class="d-block w-100" alt="...">
                        <div class="carousel-caption d-none d-md-block">
                            <h5>Tugas Function</h5>
                        </div>
                    </div>
                <div class="carousel-item">
                        <img src="asset/srt.png" class="d-block w-100" alt="...">
                        <div class="carousel-caption d-none d-md-block">
                            <h5>Sertifikat DiCoding/h5>
                        </div>
                    </div>
                </div>
